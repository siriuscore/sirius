...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " sirius-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  sirius-tx [options] <hex-tx> [commands]  Update hex-encoded sirius transaction\n" +
            "or:     sirius-tx [options] -create [commands]   Create hex-encoded sirius transaction\n" +
            "\n";
