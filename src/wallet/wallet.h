...
private:
    ...
    void StakeSiriuss(bool fStake, CConnman* connman);
...
public:
    ...
    /* Start staking siriuss */
    void StartStake(CConnman* connman) { StakeSiriuss(true, connman); }

    /* Stop staking siriuss */
    void StopStake() { StakeSiriuss(false, 0); }
