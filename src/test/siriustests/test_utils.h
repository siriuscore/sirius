...
inline dev::Address createSiriusAddress(dev::h256 hashTx, uint32_t voutNumber){
...
inline SiriusTransaction createSiriusTransaction(valtype data, dev::u256 value, dev::u256 gasLimit, dev::u256 gasPrice, dev::h256 hashTransaction, dev::Address recipient, int32_t nvout = 0){
...
inline std::pair<std::vector<ResultExecute>, ByteCodeExecResult> executeBC(std::vector<SiriusTransaction> txs){
